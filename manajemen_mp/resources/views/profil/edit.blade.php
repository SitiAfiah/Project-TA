...
<div class="container-fluid py-4">
                ...
                <div class="card-body p-4 d-flex align-items-center position-relative overflow-hidden">
                    ...
                    <div class="bg-white rounded-circle d-flex justify-content-center align-items-center shadow p-1 me-4" style="width: 80px; height: 80px; z-index: 1;">
                        @if($anggota->foto_profil)
                            <img src="{{ asset('storage/' . $anggota->foto_profil) }}" alt="Avatar" class="rounded-circle" style="width: 100%; height: 100%; object-fit: cover;">
                        @else
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($anggota->nama_lengkap) }}&background=e9ecef&color=0d6efd&size=80" alt="Avatar" class="rounded-circle" style="width: 100%; height: 100%;">
                        @endif
                    </div>
    ...
    @if($errors->any())
        <div class="alert alert-danger border-0 shadow-sm mb-4" style="border-radius: 15px;">
            <div class="d-flex align-items-center mb-2">
                <i class="icon-alert-triangle me-2 fs-5"></i> <strong>Pembaruan Gagal!</strong>
            </div>
            <ul class="mb-0">
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <form action="{{ route('profile.update') }}" method="POST" id="formProfil" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="file" name="foto_profil" class="form-control profil-input" accept="image/jpeg,image/png,image/jpg" disabled>
                                <small class="text-muted d-block mt-1">Format: JPG, JPEG, PNG. Maksimal 2MB. Kosongkan jika tidak ingin mengubah foto.</small>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jenis_kelamin" class="form-select form-control profil-input" disabled required>
