...
@section('content')
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div class="text-start">
                                ...
                                <p class="text-muted small mb-0">Klik tombol cek kehadiran untuk memverifikasi absen anggota dan upload bukti latihan.</p>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle main-table">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <small class="text-muted text-start ps-2 d-block">
                                                    ...
                                                    <i class="icon-user small"></i> {{ $item->nama_pelatih ?? 'Belum Ditentukan' }}
                                                </small>
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center py-5 text-muted small">Belum ada jadwal latihan tersedia.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
    ...
    <style>
        ...
        .btn-info { background-color: #0ea5e9; border: none; transition: 0.3s; }
        .btn-info:hover { background-color: #0284c7; transform: translateY(-2px); }
    </style>
@endsection
