                                ...
                                <td class="text-center">
                                    ...
                                    @elseif($spp->status == 'pending')
                                        <div class="d-flex justify-content-center gap-1">
                                            <button type="button" class="btn btn-sm btn-info text-white px-2 shadow-sm"
                                                    style="border-radius: 8px;"
                                                    data-bs-toggle="modal" data-bs-target="#modalBukti{{ $spp->id }}">
                                            ...
                                            <form action="{{ route('spp.bayar', $spp->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-success px-2 shadow-sm"
                                                        style="border-radius: 8px;"
                                        ...
                                        <div class="modal fade text-start" id="modalBukti{{ $spp->id }}" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content" style="border-radius: 15px;">
                                                    ...
                                                    <div class="modal-body text-center pt-3 pb-4">
                                                        <p class="text-muted small mb-3">Atas Nama: <strong>{{ $spp->anggota->nama_lengkap }}</strong></p>
                                                        @if($spp->bukti_pembayaran)
                                                            <img src="{{ asset('uploads/bukti_spp/' . $spp->bukti_pembayaran) }}" alt="Bukti Transfer" class="img-fluid rounded shadow-sm" style="max-height: 400px; object-fit: contain;">
                                                            @if($spp->tanggal_bayar)
                                                                <p class="text-muted small mt-3 mb-0">Diunggah pada: {{ \Carbon\Carbon::parse($spp->tanggal_bayar)->translatedFormat('d F Y H:i') }}</p>
                                                            @endif
                                                        @else
...
<style>
    ...
    .form-select, .form-control { border-radius: 10px; padding: 0.6rem 1rem; }
</style>
@endsection
